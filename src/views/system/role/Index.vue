        ...
        <div class="app-container">
          <el-card class="box-card">
            <div slot="header" class="clearfix">
              <span>{{ role.id === '' ? this.$t('common.add') : this.$t('common.edit') }}</span>
            </div>
            <div>
          ...
          <el-card class="box-card">
            <el-row>
              <el-col :span="24" style="text-align: right">
                <el-button type="primary" :loading="buttonLoading" plain @click="submit">{{ role.id === '' ? this.$t('common.add') : this.$t('common.edit') }}</el-button>
              </el-col>
            </el-row>
          </el-card>
        </div>
...
export default {
  ...
  methods: {
    ...
    delete(ids) {
      this.loading = true
      this.$delete(`system/role/${ids}`).then(() => {
        this.$message({
