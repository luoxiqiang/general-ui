<template>
  <div class="login-container">
    <div class="login-info">
      <div class="title">Qiang Cloud</div>
    ...
    <span class="login-footer">
      © 2020
      <a target="_blank" href="https://qiang.com">Qiang</a> - Cloud
    </span>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      codeUrl: `${process.env.VUE_APP_BASE_API}auth/getVerify`,
